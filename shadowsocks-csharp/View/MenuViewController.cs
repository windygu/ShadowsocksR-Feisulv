...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        /// 扫描飞速率官网的二维码获取服务器
        /// </summary>
        /// <param name="ss_only"></param>
        private void ScanScreenQRCodeFrom_feisulv(bool ss_only)
        {
            Thread.Sleep(100);
            foreach (Screen screen in Screen.AllScreens)
            {
        ...
        private void ScanQRCodeFrom_feisulvItem_Click(object sender, EventArgs e)
        {
            ScanScreenQRCodeFrom_feisulv(false);
        }
